...
| <a name="input_tags"></a> [tags](#input\_tags) | Optional list of tags to be added to the Redis instance and the associated service credentials (if creating). | `list(any)` | `[]` | no |

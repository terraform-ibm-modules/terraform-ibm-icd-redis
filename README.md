...
* [Examples](./examples)
   * [Restore from backup example](./examples/backup-restore) [[Deploy with IBM Cloud Schematics]](https://cloud.ibm.com/schematics/workspaces/create?workspace_name=ir-backup-restore-example&repository=https://github.com/terraform-ibm-modules/terraform-ibm-icd-redis/tree/main/examples/backup-restore)

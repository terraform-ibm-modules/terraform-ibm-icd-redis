...
* [Examples](./examples)
    * <div style="display: inline-flex; align-items: center; gap: 8px;"><a href="./examples/backup-restore">Restore from backup example</a><a href="https://cloud.ibm.com/schematics/workspaces/create?workspace_name=ir-backup-restore-example&repository=https://github.com/terraform-ibm-modules/terraform-ibm-icd-redis/tree/main/examples/backup-restore" target="_blank" rel="noopener noreferrer"><img src="https://cloud.ibm.com/media/docs/images/icons/Deploy_to_cloud.svg" alt="Deploy to IBM Cloud button" style="height: 1em; vertical-align: middle;"></a></div>
